...
xButton.addEventListener('click', () => {
    ...
    xIcon.style.filter = "invert(86%) sepia(13%) saturate(4%) hue-rotate(153deg) brightness(30%) contrast(81%)";
    yIcon.style.filter = "invert(66%) sepia(53%) saturate(74%) hue-rotate(1000deg) brightness(489%) contrast(51%)";
...
yButton.addEventListener('click', () => {
    ...
    yIcon.style.filter = "invert(86%) sepia(13%) saturate(4%) hue-rotate(153deg) brightness(30%) contrast(81%)";
    xIcon.style.filter = "invert(66%) sepia(53%) saturate(74%) hue-rotate(1000deg) brightness(489%) contrast(51%)";
    Xchoose = false;
...
box.forEach(element => {
    element.addEventListener("click", () => {
        if(!element.classList.contains("dropO") && !element.classList.contains("dropX")) {
            count++;
            ...
            if(countXFirstLine == 3 || countXSecondLine == 3 || countXThirdLine == 3 || countXDiagonalFirst == 3 || countXDiagonalSecond == 3 || countXFirstColumn == 3 || countXSecondColumn == 3 || countXThirdColumn == 3){
                lastScreen.style.display = "flex";
            ...
            if(countOFirstLine == 3 || countOSecondLine == 3 || countOThirdLine == 3 || countODiaglonalFirst == 3 || countODiagonalSecond == 3 || countOFirstColumn == 3 || countOSecondColumn == 3 || countOThirdColumn == 3){
                lastScreen.style.display = "flex";
        ...
        if(countForDraw == 9 && oWinBox.style.display == "none" && xWinBox.style.display == "none") {
            lastScreen.style.display = "flex";
